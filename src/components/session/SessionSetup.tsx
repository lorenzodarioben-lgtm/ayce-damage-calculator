      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="sm:col-span-2">
          ...
          <input
            ...
            className="h-12 w-full rounded-surface border border-line bg-ash-900 px-3 text-body text-cream-50 placeholder:text-cream-700"
          />
        </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="tabular h-12 w-full rounded-surface border border-line bg-ash-900 pl-7 pr-3 text-body text-cream-50"
            />
          </div>
          <p
            id={priceHintId}
