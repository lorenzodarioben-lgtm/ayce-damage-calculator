          ...
          {diners.map((diner, index) => (
            <li key={diner.id} className="flex items-center gap-2 rounded-surface bg-ash-900 p-2">
              ...
              <input
                ...
                placeholder="Default"
                className="h-11 w-24 rounded-surface border border-line-strong bg-ash-850 px-2 text-right text-ui text-cream-100 placeholder:text-cream-600"
              />
              <div className="flex shrink-0">
                <button
                  ...
                  className="flex size-11 cursor-pointer items-center justify-center rounded-surface text-cream-500 hover:bg-ash-800 focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-ember-400 disabled:cursor-not-allowed disabled:opacity-40"
                >
                ...
                <button
                  ...
                  className="flex size-11 cursor-pointer items-center justify-center rounded-surface text-char-400 hover:bg-char-700/25 focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-char-500"
                >
