...
export function SkipLink() {
  return (
    <a
      ...
      className="fixed left-4 top-2 z-50 -translate-y-[150%] rounded-surface border border-line-ember bg-ash-850 px-4 py-2 text-caption font-semibold uppercase tracking-caps text-ember-400 transition-transform duration-150 focus-visible:translate-y-0"
    >
      Skip to content
    </a>
  );
