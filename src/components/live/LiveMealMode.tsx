...
export function LiveMealMode() {
  ...
  return (
    <>
      ...
      <main className="relative z-10 mx-auto max-w-[640px] px-4 pt-4 pb-28 sm:px-6">
        ...
        <div className="mt-6 space-y-2">
          ...
          <p className="text-center text-xs text-cream-700">
            {formatMoney(session.pricePerDiner)} per diner × {session.dinerCount}.{' '}
      ...
      <SiteFooter>
        Live mode edits the same session as the calculator. Anything logged here appears on the full
