    ...
    <div className="space-y-2">
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full resize-none rounded-surface border border-line bg-ash-900 px-3 py-2 text-ui text-cream-100 placeholder:text-cream-700 disabled:opacity-60"
        />
      </div>
