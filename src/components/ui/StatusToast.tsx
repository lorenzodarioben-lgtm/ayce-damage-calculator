      ...
      {message && (
        <p
          className={cn(
            ...
            'bg-ash-800/95 text-center text-ui font-medium text-cream-100 backdrop-blur-md',
            'elevate-float',
