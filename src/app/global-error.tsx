        ...
        <main className="relative z-10 mx-auto flex min-h-dvh max-w-[560px] flex-col justify-center px-4 py-16 sm:px-6">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <button
              type="button"
              onClick={retry}
              className="inline-flex min-h-14 cursor-pointer items-center justify-center rounded-surface bg-ember-500 px-6 text-body font-bold uppercase tracking-caps text-ash-950 transition-colors duration-200 hover:bg-ember-400"
            >
              Try again
            </button>
